  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <button
        ...
        disabled={loading}
        className="flex items-center gap-2 px-4 py-2 bg-blue-600 hover:bg-blue-500 disabled:bg-slate-400 text-white text-sm font-semibold rounded-lg transition-colors"
      >
